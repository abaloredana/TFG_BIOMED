...
#THIS FILE GOES INSIDE chiswhisperer/software/chipwhisperer/analyzer/ 
#This code must substitute the existing __init__.py within said directory

leakage_models = EightBitAES128LeakageModels()


def cpa(proj, leak_model, algorithm=cpa_algorithms.CPAProgressiveCustom): #Changed the class responsible of creating the CPA object to the new custom one
